...
## [lucidrains/PaLM-rlhf-pytorch](https://github.com/lucidrains/PaLM-rlhf-pytorch) ⭐ 7,862 | 🐛 20 | 🌐 Python | 📅 2026-07-27
...
## [oobabooga/text-generation-webui](https://github.com/oobabooga/text-generation-webui) ⭐ 47,668 | 🐛 839 | 🌐 Python | 📅 2026-08-17

A gradio web UI for running Large Language Models like GPT-J 6B, OPT, GALACTICA, LLaMA, and Pygmalion.

Tags: Full

## [KoboldAI/KoboldAI-Client](https://github.com/KoboldAI/KoboldAI-Client) ⭐ 3,946 | 🐛 120 | 🌐 Python | 📅 2025-01-16

This is a browser-based front-end for AI-assisted writing with multiple local & remote AI models. It offers the standard array of tools, including Memory, Author’s Note, World Info, Save & Load, adjustable AI settings, formatting options, and the ability to import existing AI Dungeon adventures. You can also turn on Adventure mode and play the game like AI Dungeon Unleashed.

Tags: Full

## [LAION-AI/Open-Assistant](https://github.com/LAION-AI/Open-Assistant) ⭐ 37,398 | 🐛 296 | 🌐 Python | 📅 2024-08-17
...
## [tatsu-lab/stanford\_alpaca](https://github.com/tatsu-lab/stanford_alpaca) ⭐ 30,243 | 🐛 186 | 🌐 Python | 📅 2024-07-17
...
* [ggerganov/llama.cpp](https://github.com/ggerganov/llama.cpp) ⭐ 128,192 | 🐛 2,468 | 🌐 C++ | 📅 2026-09-14 Ports for inferencing LLaMA in C/C++ running on CPUs, supports alpaca, gpt4all, etc.
* [nomic-ai/gpt4all](https://github.com/nomic-ai/gpt4all) ⭐ 77,394 | 🐛 771 | 🌐 C++ | 📅 2025-05-27 Demo, data and code to train an assistant-style large language model with \~800k GPT-3.5-Turbo Generations based on LLaMA.
* [hpcaitech/ColossalAI#ColossalChat](https://github.com/hpcaitech/ColossalAI/tree/main/applications/Chat) ⭐ 41,443 | 🐛 504 | 🌐 Python | 📅 2026-08-31 An open-source solution for cloning ChatGPT with a complete RLHF pipeline.
* [lm-sys/FastChat](https://github.com/lm-sys/FastChat) ⭐ 39,525 | 🐛 1,045 | 🌐 Python | 📅 2026-05-01 An open platform for training, serving, and evaluating large language model based chatbots.
* [tloen/alpaca-lora](https://github.com/tloen/alpaca-lora) ⭐ 18,909 | 🐛 365 | 🌐 Jupyter Notebook | 📅 2024-07-29 Code for rproducing the Stanford Alpaca results using low-rank adaptation (LoRA).
* [setzer22/llama-rs](https://github.com/setzer22/llama-rs) ⚠️ Archived Rust port of the llama.cpp project.
* [Lightning-AI/lit-llama](https://github.com/Lightning-AI/lit-llama) ⭐ 6,083 | 🐛 107 | 🌐 Python | 📅 2025-07-01 Implementation of the LLaMA language model based on nanoGPT.
...
## [BlinkDL/ChatRWKV](https://github.com/BlinkDL/ChatRWKV) ⭐ 9,495 | 🐛 62 | 🌐 Python | 📅 2026-07-19

ChatRWKV is like ChatGPT but powered by RWKV (100% RNN) language model, and open source.

Tags: Full

## [THUDM/ChatGLM-6B](https://github.com/THUDM/ChatGLM-6B) ⭐ 40,962 | 🐛 605 | 🌐 Python | 📅 2024-06-27
...
* Alternative Web UI: [Akegarasu/ChatGLM-webui](https://github.com/Akegarasu/ChatGLM-webui) ⭐ 1,883 | 🐛 25 | 🌐 Python | 📅 2023-07-25
...
## [databrickslabs/dolly](https://github.com/databrickslabs/dolly) ⭐ 10,808 | 🐛 5 | 🌐 Python | 📅 2023-06-30

Databricks’ dolly-v2-12b, an instruction-following large language model trained on the Databricks machine learning platform that is licensed for commercial use. Based on pythia-12b trained on \~15k instruction/response fine tuning records [databricks-dolly-15k](https://github.com/databrickslabs/dolly/tree/master/data) ⭐ 10,808 | 🐛 5 | 🌐 Python | 📅 2023-06-30 generated by Databricks employees in capability domains from the InstructGPT paper.
...
## [LianjiaTech/BELLE](https://github.com/LianjiaTech/BELLE) ⭐ 8,270 | 🐛 106 | 🌐 HTML | 📅 2024-10-16
...
* [English readme](https://github.com/LianjiaTech/BELLE#-belle-be-large-language-model-engine-1) ⭐ 8,270 | 🐛 106 | 🌐 HTML | 📅 2024-10-16
...
## [TavernAI/TavernAI](https://github.com/TavernAI/TavernAI) ⭐ 78 | 🐛 3 | 📅 2026-09-04

Atmospheric adventure chat for AI language model **Pygmalion** by default and other models such as **KoboldAI**, ChatGPT, GPT-4

Tags: Full

## [Cohee1207/SillyTavern](https://github.com/Cohee1207/SillyTavern) ⭐ 33,352 | 🐛 618 | 🌐 JavaScript | 📅 2026-09-07
...
## [mlc-ai/web-llm](https://github.com/mlc-ai/web-llm) ⭐ 19,118 | 🐛 152 | 🌐 TypeScript | 📅 2026-09-13
...
## [Stability-AI/StableLM](https://github.com/Stability-AI/StableLM) ⭐ 15,679 | 🐛 27 | 🌐 Jupyter Notebook | 📅 2024-04-08
...
* [StableVicuna](https://github.com/Stability-AI/StableLM#stablevicuna) ⭐ 15,679 | 🐛 27 | 🌐 Jupyter Notebook | 📅 2024-04-08 an RLHF fine-tune of Vicuna-13B v0, which itself is a fine-tune of LLaMA-13B.
...
* [A bit translated readme to English](https://github.com/nichtdax/awesome-totally-open-chatgpt/issues/18#issuecomment-1492826662) ⭐ 4,787 | 🐛 9 | 📅 2023-05-03

Tags: Full

## [OpenLMLab/MOSS](https://github.com/OpenLMLab/MOSS) ⭐ 12,245 | 🐛 243 | 🌐 Python | 📅 2026-09-06

MOSS: An open-source tool-augmented conversational language model from Fudan University. (Most examples are in Chinese)

Related links:

* [English readme](https://github.com/OpenLMLab/MOSS/blob/main/README_en.md) ⭐ 12,245 | 🐛 243 | 🌐 Python | 📅 2026-09-06
