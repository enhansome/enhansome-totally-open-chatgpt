...
## [oobabooga/text-generation-webui](https://github.com/oobabooga/text-generation-webui) ⭐ 47,552 | 🐛 833 | 🌐 Python | 📅 2026-06-02
...
* [ggerganov/llama.cpp](https://github.com/ggerganov/llama.cpp) ⭐ 124,083 | 🐛 2,056 | 🌐 C++ | 📅 2026-08-16 Ports for inferencing LLaMA in C/C++ running on CPUs, supports alpaca, gpt4all, etc.
* [nomic-ai/gpt4all](https://github.com/nomic-ai/gpt4all) ⭐ 77,411 | 🐛 774 | 🌐 C++ | 📅 2025-05-27 Demo, data and code to train an assistant-style large language model with \~800k GPT-3.5-Turbo Generations based on LLaMA.
* [hpcaitech/ColossalAI#ColossalChat](https://github.com/hpcaitech/ColossalAI/tree/main/applications/Chat) ⭐ 41,437 | 🐛 504 | 🌐 Python | 📅 2026-08-10 An open-source solution for cloning ChatGPT with a complete RLHF pipeline.
* [lm-sys/FastChat](https://github.com/lm-sys/FastChat) ⭐ 39,513 | 🐛 1,038 | 🌐 Python | 📅 2026-05-01 An open platform for training, serving, and evaluating large language model based chatbots.
...
## [THUDM/ChatGLM-6B](https://github.com/THUDM/ChatGLM-6B) ⭐ 40,988 | 🐛 607 | 🌐 Python | 📅 2024-06-27
...
## [databrickslabs/dolly](https://github.com/databrickslabs/dolly) ⭐ 10,804 | 🐛 6 | 🌐 Python | 📅 2023-06-30

Databricks’ dolly-v2-12b, an instruction-following large language model trained on the Databricks machine learning platform that is licensed for commercial use. Based on pythia-12b trained on \~15k instruction/response fine tuning records [databricks-dolly-15k](https://github.com/databrickslabs/dolly/tree/master/data) ⭐ 10,804 | 🐛 6 | 🌐 Python | 📅 2023-06-30 generated by Databricks employees in capability domains from the InstructGPT paper.
...
## [Cohee1207/SillyTavern](https://github.com/Cohee1207/SillyTavern) ⭐ 32,182 | 🐛 583 | 🌐 JavaScript | 📅 2026-07-11
...
## [mlc-ai/web-llm](https://github.com/mlc-ai/web-llm) ⭐ 18,564 | 🐛 153 | 🌐 TypeScript | 📅 2026-08-04
...
## [OpenLMLab/MOSS](https://github.com/OpenLMLab/MOSS) ⭐ 12,214 | 🐛 243 | 🌐 Python | 📅 2026-05-27

MOSS: An open-source tool-augmented conversational language model from Fudan University. (Most examples are in Chinese)

Related links:

* [English readme](https://github.com/OpenLMLab/MOSS/blob/main/README_en.md) ⭐ 12,214 | 🐛 243 | 🌐 Python | 📅 2026-05-27
